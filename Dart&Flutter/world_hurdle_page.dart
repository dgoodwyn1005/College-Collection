...
import 'package:project_wordle/hurdle_provider.dart';
import 'package:project_wordle/keyboard_view.dart';
import 'wordle_view.dart';
import 'package:project_wordle/helper_functions.dart';
                ...
                builder: (context, provider, child) => GridView.builder(
                  gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                    ...
                    itemBuilder:(context, index){
                      final letter = provider.hurdleBoard[index];
                      return WordleView(wordle:letter);
                    }),
                ),
              ),
            ),  
                    ...
                    ElevatedButton(
                      onPressed: () {
                        if(!provider.isAValidWord){
                          showMsg(context, "Not in the dictionary");
                          return;
                        }
